        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Groups_Accounts_LeaderID",
                        column: x => x.LeaderID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MeetingCode = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "newid()"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Meetings", x => x.MeetingCode);
                    table.ForeignKey(
